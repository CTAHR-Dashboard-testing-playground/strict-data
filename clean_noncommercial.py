"""
Non-Commercial Fisheries Data Cleaning Module

Processes non-commercial fisheries exchange value data from Hawaii.
Data covers 2005-2022, organized by island (6 islands).
Source: MRIP Hawaii Marine Recreational Fishing Survey with SEEA EA exchange value methodology
Note: Input data is pre-tidied from process_fisheries_ev_data.qmd
Note: Ni'ihau and Kaho'olawe not included (MRIP survey does not cover those islands)
"""
...
class NonCommercialDataCleaner:
    ...
    def load_data(self):
        """
        Load non-commercial fisheries CSV from input directory.
        Looks for files matching pattern '*tidied_noncomm_ev*.csv'.
    ...
    def validate_ecosystem_types(self):
        ...
        Note: All herbivores map to 100% reef habitat, so Coastal — Open Ocean should be zero.
        """
    ...
    def validate_species_groups(self):
        """
        Validate that non-commercial data contains only Herbivores species group.
        """
    ...
    def validate_islands(self):
        """
        Validate that island names are from surveyed Hawaiian islands.
        Expected: Hawaii, Kauai, Lanai, Maui, Molokai, Oahu
    ...
    def remove_aggregate_rows(self, remove_aggregates=True):
        ...
        Removes records where ecosystem_type is 'All Ecosystems'.
    ...
    def remove_display_columns(self, remove_display=False):
        ...
        Display columns: island_olelo, county_olelo, exchange_value_formatted
    ...
    def run_cleaning_pipeline(self, remove_aggregates=True, remove_display=False):
        ...
        Args:
            remove_aggregates (bool): Remove 'All Ecosystems' rows. Default True.
